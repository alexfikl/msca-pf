...
option in the document class. When in doubt, always consult the official template and
programme guide!
\end{mscaexplanation}
...
\begin{itemize}
    ...
    delivering on its objectives. If you believe that none of
...
\begin{itemize}
    ...
    management/organisation, horizontal and key transferable skills \dots).
