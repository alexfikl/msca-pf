...
Charter\footnotemark{} during its implementation.

\footnotetext{MSCA Green Charter \url{https://ec.europa.eu/msca/green_charter}.
While the MSCA Green Charter is non-binding and adherence to it will not be
subject to evaluation, funded projects are strongly encouraged to take into
account the principles it sets out.}

\section{Required for Global Fellowships only: Letter(s) of commitment from
...
HE-MSCA-PF-2023, should the proposal be funded.
