...
% WARNING: Tagging/Accessible PDFs require running with LuaLaTeX
...
\documentclass[12pt,tagged,draftproposal]{msca-pf}
...
% \mscaidentifier{HORIZON-MSCA-2026-PF-01}
% \mscaproject{TDB}
...
\begin{mscaexplanation}
\itshape The text in each section is provided only as guidance and should not be part of
the final proposal. It is removed automatically when removing the \texttt{draftproposal}
option in the document class. However, some of the tables are part of the document
format and should be used and expanded from the ones provided here.

When in doubt, always consult the official template and programme guide!
\end{mscaexplanation}
...
You may modify the template below as necessary to include all relevant information.
\end{mscaexplanation}
...
clearly indicate the date of the successful, unconditional PhD defence (``viva'').
Researchers having their last thesis defence after the call deadline will be automatically
...
\begin{itemize}
    ...
    \item Associated partner for outgoing phase (mandatory for GF only)
...
\begin{mscaexplanation}
\itshape Demonstrate that the beneficiary has sufficient facilities and infrastructure
...
If applicable, indicate the name of the associated partner linked to a beneficiary
...
\begin{mscaexplanation}
\itshape Indicate up to 5 relevant EU, national or international research and training
...
\section{Environmental considerations in light of the MSCA Green Charter}
...
\section{
    Required for Global Fellowships only: Letter of commitment from the
    associated partner hosting the outgoing phase}
...
HORIZON-MSCA-2026-PF-01, should the proposal be funded.
